...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'sqlite-persistent' => [
            'driver' => 'sqlite',
            'database' => env('DB_DATABASE', __DIR__ . '/../database/sparkle.sqlite'),
            'prefix' => '',
        ],
        ...
        'mysql-ci' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', 3306),
            'database' => env('DB_DATABASE', 'sparkle'),
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'sparkle'), '_') . '_database_'),
        ],
