...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Sparkle provides the ability to prohibit or allow [default] downloading music
    |
    */
    ...
    */
    ...
    'misc' => [
        'home_url' => 'https://sparkle.dev',
        'docs_url' => 'https://docs.sparkle.dev',
        'sponsor_github_url' => '',
        'sponsor_open_collective_url' => 'https://opencollective.com/sparkle',
        'demo' => env('SPARKLE_DEMO', false),
    ],
];
