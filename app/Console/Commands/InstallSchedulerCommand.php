...
{
    protected $signature = 'sparkle:scheduler:install';
    protected $description = 'Install the scheduler for Sparkle';
    ...
    public function handle(): int
    {
        ...
        if (self::schedulerInstalled($crontab)) {
            $this->components->info('Sparkle scheduler is already installed. Skipping…');
