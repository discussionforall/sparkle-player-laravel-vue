...
{
    protected $signature = 'sparkle:storage:local';
    protected $description = 'Set up the local storage for Sparkle';
    ...
    {
        $this->components->info('Setting up local storage for Sparkle.');
