      ...
      <main class="space-y-5">
        <FormRow :cols="2">
          <FormRow>
            ...
            <TextInput v-model="name" v-sparkle-focus name="name" placeholder="Playlist name" required />
          </FormRow>
          <FormRow>
        ...
        <div v-sparkle-overflow-fade class="group-container space-y-5 overflow-auto max-h-[480px]">
          <RuleGroup
