      ...
      <ScreenHeader v-if="podcast" :layout="headerLayout">
        ...
        <template #controls>
          <div class="flex gap-2 flex-wrap">
            ...
            <BtnGroup uppercase>
              <Btn v-if="episodes" v-sparkle-tooltip="'Refresh'" success @click.prevent="refresh">
                <Icon :icon="faRotateRight" fixed-width />
              </Btn>
              <Btn v-sparkle-tooltip="'Unsubscribe'" danger uppercase @click.prevent="unsubscribe">
            ...
            <Btn v-sparkle-tooltip="'Visit podcast website'" tag="a" gray :href="podcast.link" target="_blank">
