  ...
  <section class="text-k-text-secondary">
    ...
    <div v-if="useSpotify">
      <p>
        ...
        Sparkle will attempt to retrieve album arts and artist images from Spotify when a song is played, if needed.
      </p>
    </div>
    <div v-else>
      <p>
        ...
        <span v-if="isAdmin" data-testid="spotify-admin-instruction">
          Check
          <a href="https://docs.sparkle.dev/service-integrations#spotify" target="_blank">
            Documentation
          </a>
          for instructions.
        </span>
