<template>
  <section class="text-k-text-secondary">
    ...
    <div v-if="useLastfm" data-testid="lastfm-integrated">
      <p>Last.fm integration is enabled. Sparkle will attempt to retrieve album and artist information from Last.fm.</p>
      <p v-if="connected">
      ...
      <p>
        Connecting Sparkle and your Last.fm account enables such exciting features as
    ...
    <div v-else data-testid="lastfm-not-integrated">
      <p>
        ...
        <span v-if="isAdmin" data-testid="lastfm-admin-instruction">
          Check
          <a class="text-k-highlight" href="https://docs.sparkle.dev/service-integrations#last-fm" target="_blank">
            Documentation
          </a>
          for instructions.
        </span>
 ...
 * Sparkle will reload once the connection is successful.
 */
