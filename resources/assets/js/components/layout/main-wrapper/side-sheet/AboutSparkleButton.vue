<template>
  <!-- <SideSheetButton
    v-sparkle-tooltip.left
    :title="shouldNotifyNewVersion ? 'New version available!' : 'About Sparkle'"
    @click.prevent="openAboutSparkleModal"
  >
...
const openAboutSparkleModal = () => eventBus.emit('MODAL_SHOW_ABOUT_SPARKLE')
</script>
