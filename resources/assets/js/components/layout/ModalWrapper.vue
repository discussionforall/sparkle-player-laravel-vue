...
const modalNameToComponentMap = {
  'about-sparkle': defineAsyncComponent(() => import('@/components/meta/AboutSparkleModal.vue')),
  ...
  'sparkle-plus': defineAsyncComponent(() => import('@/components/sparkle-plus/SparklePlusModal.vue')),
...
eventBus.on('MODAL_SHOW_ABOUT_SPARKLE', () => (activeModalName.value = 'about-sparkle'))
  .on('MODAL_SHOW_SPARKLE', () => (activeModalName.value = 'sparkle-plus'))
