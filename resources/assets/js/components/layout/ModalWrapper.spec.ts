...
new class extends UnitTestCase {
  protected test () {
    it.each<[string, keyof Events, User | Playable[] | Playlist | PlaylistFolder | undefined]>([
      ...
      ['about-sparkle', 'MODAL_SHOW_ABOUT_SPARKLE', undefined],
      ['sparkle-plus', 'MODAL_SHOW_SPARKLE', undefined],
      ...
      this.render(ModalWrapper, {
        global: {
          stubs: {
            AboutSparkleModal: this.stub('about-sparkle'),
            ...
            SparklePlus: this.stub('sparkle-plus'),
