<template>
  ...
  >
    <p class="flex-1">
      Loving Sparkle? Please consider supporting its development via
      <a href="" rel="noopener" target="_blank">GitHub Sponsors</a>
      and/or
      <a href="" rel="noopener" target="_blank">OpenCollective</a>.
    </p>
