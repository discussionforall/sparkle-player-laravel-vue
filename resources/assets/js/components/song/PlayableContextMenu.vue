    ...
    <li class="has-sub">
      ...
      <ul class="submenu menu-add-to context-menu">
        ...
        <template class="block">
          <ul v-if="normalPlaylists.length" v-sparkle-overflow-fade class="relative max-h-48 overflow-y-auto">
...
const canBeShared = computed(() => (isSong(playables.value[0]) && playables.value[0].is_public))
