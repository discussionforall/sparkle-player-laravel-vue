...
class DownloadTest extends TestCase
{
    ...
    public function downloadOneSong(): void
    {
        ...
        $this->get("download/songs?songs[]={$song->id}&api_token=" . $user->createToken('Sparkle')->plainTextToken)
            ->assertOk();
    }
    ...
    public function downloadMultipleSongs(): void
    {
        ...
        $this->get(
            ...
            . $user->createToken('Sparkle')->plainTextToken
        )
            ->assertOk();
    }
    ...
    public function downloadAlbum(): void
    {
        ...
        $this->get("download/album/{$album->id}?api_token=" . $user->createToken('Sparkle')->plainTextToken)
            ->assertOk();
    }
    ...
    public function downloadArtist(): void
    {
        ...
        $this->get("download/artist/{$artist->id}?api_token=" . $user->createToken('Sparkle')->plainTextToken)
            ->assertOk();
    }
    ...
    public function downloadPlaylist(): void
    {
        ...
        $this->get("download/playlist/{$playlist->id}?api_token=" . $user->createToken('Sparkle')->plainTextToken)
            ->assertOk();
    }
    ...
    public function nonOwnerCannotDownloadPlaylist(): void
    {
        ...
        $this->get("download/playlist/{$playlist->id}?api_token=" . create_user()->createToken('Sparkle')->plainTextToken)
            ->assertForbidden();
    }
    ...
    public function downloadFavorites(): void
    {
        ...
        $this->get('download/favorites?api_token=' . $user->createToken('Sparkle')->plainTextToken)
            ->assertOk();
    }
}
