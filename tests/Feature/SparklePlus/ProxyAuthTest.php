...
namespace Tests\Feature\SparklePlus;
...
class ProxyAuthTest extends PlusTestCase
{
    public function setUp(): void
    {
        ...
        config([
            'sparkle.proxy_auth.enabled' => true,
            'sparkle.proxy_auth.allow_list' => ['192.168.1.0/24'],
            'sparkle.proxy_auth.user_header' => 'remote-user',
            'sparkle.proxy_auth.preferred_name_header' => 'remote-preferred-name',
        ]);
    }
    ...
    {
        config([
            'sparkle.proxy_auth.enabled' => false,
            'sparkle.proxy_auth.allow_list' => [],
            'sparkle.proxy_auth.user_header' => 'remote-user',
            'sparkle.proxy_auth.preferred_name_header' => 'remote-preferred-name',
        ]);
