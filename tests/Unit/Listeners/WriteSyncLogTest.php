...
class WriteSyncLogTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->originalLogLevel = config('sparkle.sync_log_level');
    ...
    protected function tearDown(): void
    {
        ...
        config(['sparkle.sync_log_level' => $this->originalLogLevel]);
    ...
    {
        config(['sparkle.sync_log_level' => 'all']);
    ...
    {
        config(['sparkle.sync_log_level' => 'error']);
