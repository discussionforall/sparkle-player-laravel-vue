...
class MediaMetadataServiceTest extends TestCase
{
    ...
    public function writeAlbumCover(): void
    {
        ...
        $coverPath = '/sparkle/public/img/album/foo.jpg';

        $this->imageWriter
            ->shouldReceive('write')
            ->once()
            ->with('/sparkle/public/img/album/foo.jpg', 'dummy-src');
    ...
    public function writeArtistImage(): void
    {
        ...
        $imagePath = '/sparkle/public/img/artist/foo.jpg';

        $this->imageWriter
            ->shouldReceive('write')
            ->once()
            ->with('/sparkle/public/img/artist/foo.jpg', 'dummy-src');
