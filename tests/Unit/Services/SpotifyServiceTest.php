...
class SpotifyServiceTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        config([
            'sparkle.spotify.client_id' => 'fake-client-id',
            'sparkle.spotify.client_secret' => 'fake-client-secret',
        ]);
    ...
    {
        config(['sparkle.spotify.client_id' => null]);
    ...
    {
        config([
            'sparkle.spotify.client_id' => null,
            'sparkle.spotify.client_secret' => null,
        ]);
