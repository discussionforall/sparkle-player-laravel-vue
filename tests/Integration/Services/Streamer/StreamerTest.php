...
class StreamerTest extends TestCase
{
    ...
    {
        config(['sparkle.streaming.transcode_flac' => true]);
        ...
        config(['sparkle.streaming.transcode_flac' => false]);
    }
    ...
    {
        config(['sparkle.streaming.method' => $config]);
        ...
        config(['sparkle.streaming.method' => null]);
    }
